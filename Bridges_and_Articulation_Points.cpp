...
private:
    int timer = 1;
    void dfsbridges(int node, int parent, vector<int> &vis,
        ...
        for (auto it : adj[node]) {
            ...
            if (vis[it] == 0) {
                dfsbridges(it, node, vis, adj, tin, low, bridges);
    ...
    int timer = 1;
    void dfsart(int node, int parent, vector<int> &vis, int tin[], int low[],
...
public:
    ...
    vector<vector<int>>& connections) {
        ...
        dfsbridges(0, -1, vis, adj, tin, low, bridges);
        return bridges;
    }
